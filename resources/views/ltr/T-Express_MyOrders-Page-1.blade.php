...
<!--Start body-->
    ...
    <div class="px-lg-0">
      ...
      <div style="color: #2196f3 !important;"class="container text-white py-5 text-center">
        ...
        <p class="lead mb-0">Select one of your orders to check out!</p>
                  ...
                  <thead>
                    <tr style="background-color:#c6e2ff!important;">
                      <th scope="col" class="border-0">
                        <div style="font-size: 20px!important;color: #2196f3 !important; font-weight: 500!important;" class="p-2 px-3 text-uppercase">Order Number</div>
                      </th>
                      <th scope="col" class="border-0">
                    ...
                    <tr>
                      <th scope="row" class="border-0">
                        <div class="ml-3 d-inline-block align-middle">
                            <h5 class="mb-0"> <a href="T-Express_MyOrders-Page-2" class="text-dark d-inline-block align-middle">123456789</a></h5><span class="text-muted font-weight-normal font-italic d-block">Market: Sakr</span>
                          </div>
                        </div>
                      </th>
                      <td class="border-0 align-middle"><strong> 203.5 EGP</strong></td>
                      <td class="border-0 align-middle">19/10/2019<a class="text-dark">
                    </tr>
                    <tr>
                      <th scope="row">
                          <div class="ml-3 d-inline-block align-middle">
                            <h5 class="mb-0"><a href="T-Express_MyOrders-Page-2" class="text-dark d-inline-block">789456123</a></h5><span class="text-muted font-weight-normal font-italic">Market: Metro</span>
                          </div>
                      </th>
                      <td class="align-middle"><strong> 147.99 EGP</strong></td>
                      <td class="align-middle">15/2/2019<a class="text-dark">
                      </td>
                    </tr>
                  </tbody>
                </table>
