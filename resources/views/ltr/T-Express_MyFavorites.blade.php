                  ...
                  <thead>
                    <tr style="background-color:#c6e2ff!important;">
                      <th scope="col" class="border-0">
                        <div style="font-size: 20px!important;color: #2196f3 !important;" class="p-2 px-3 text-uppercase">Product</div>
                      </th>
                      <th scope="col" class="border-0">
                        <div style="font-size: 20px!important;color: #2196f3 !important;" class="py-2 text-uppercase"><i class="fas fa-money-bill-wave"></i></div>
                      </th>
                      <th scope="col" class="border-0">
                        <div style="font-size: 20px!important;color: #2196f3 !important;" class="py-2 text-uppercase"><i class="far fa-star"></i></div>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      ...
                      <td class="border-0 align-middle"><a style="font-size: 20px!important;color: #2196f3 !important;" href="#" class="text-dark"><i class="fab fa-opencart">&nbsp;</i><i class="far fa-trash-alt"></i>
                    </tr>
                    <tr>
                      <th scope="row" class="border-0">
                        <div class="p-2">
                      ...
                      <td class="align-middle"><a style="font-size: 20px!important;color: #2196f3 !important;" href="#" class="text-dark"><i class="fab fa-opencart">&nbsp;</i><i class="far fa-trash-alt"></i>
                      </td>
                    </tr>
                    <tr>
                      <th scope="row" class="border-0">
