    ...
    <!--Start Change Password-->
        ...
        <div class="card">
            ...
            <form class="text-center border-light" action="#!">
              ...
              <p style="color: #2196f3 !important;"class="h4 mb-4">Reset Your Password ?</p>

              <input type="email" id="defaultLoginFormEmail" class="form-control mb-4" placeholder="Current Password">

              <input type="password" id="defaultLoginFormPassword" class="form-control mb-4" placeholder="New Password">

              <input type="password" id="defaultLoginFormPassword" class="form-control mb-4" placeholder="Verify Password">

              <button style="background-color:#2196f3 !important;" class="btn btn-info btn-block my-4 rounded-pill" type="submit">Reset Password</button>
            </form>
        </div>
        </div>
        </div>       
