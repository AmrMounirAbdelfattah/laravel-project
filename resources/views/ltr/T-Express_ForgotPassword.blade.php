...
<!--Start body-->
    ...
    <!--Start Change Password-->
        ...
        <form method="POST" action="{{ route('password.update') }}">
              ...
              <p style="color: #2196f3 !important;"class="h4 mb-4">Forgot Password ?</p>

              <p style="color: #2196f3 !important;"class=" mb-4">No worries! Enter your email and we will sent you a reset.</p>

              
              <input id="email" type="email" class="form-control mb-4 @error('email') is-invalid @enderror"placeholder="Email"name="email" value="{{ $email ?? old('email') }}" required autocomplete="email" autofocus>
              ...
              <button style="background-color:#2196f3 !important;" class="btn btn-info btn-block my-4 rounded-pill" type="submit">Send Request</button>
              <p>Go back to 
                <a style="color: #2196f3;" href="{{ route('login') }}">Sign In</a>
            </p>
            </form>
        </div>
        </div>
