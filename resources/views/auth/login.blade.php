            ...
            <form method="POST" action="{{ route('login') }}">
              ...
              <div class="d-flex justify-content-around">
                  <div style="background-color: #c6e2ff;"class="rounded-pill px-4 py-3 text-uppercase font-weight-bold" >
                      ...
                      <!-- Forgot password -->
                      <a style="color: red;" href="{{ route('password.request') }}">Forgot password?</a>
              ...
              <!-- Social login -->
              <p>or sign in with:</p>
              <a href="login/facebook" style="font-size: 40px!important;color: #3b5998!important;" class="fb-ic mr-3" role="button"><i class="fab fa-facebook-f"></i></a>
                <a href="login/google" style="font-size: 40px!important;color: #dd4b39!important;" class="gplus-ic mr-3" role="button"><i class="fab fa-google"></i></a>
            </form>
