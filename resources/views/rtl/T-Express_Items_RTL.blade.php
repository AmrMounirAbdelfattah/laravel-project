...
<div style="color:#31AFF5;font-size: 20px;" class="nav-item dropdown">
  ...
  <a class="nav-link dropdown-toggle" id="navbarDropdownMenuLink-4" data-toggle="dropdown"
    aria-haspopup="true" aria-expanded="false">
    <i class="fas fa-list"> ترتيب حسب</i>
  </a>
  <div style="margin-right:0px!important;float: right !important;text-align: center!important;"class="dropdown-menu dropdown-menu-right dropdown-default"
    aria-labelledby="navbarDropdownMenuLink-4">
        <a class="dropdown-item" href="#"> الأفضل</a>
        <a class="dropdown-item" href="#"> السعر (الأقل إلى الأعلى)</a>
        <a class="dropdown-item" href="#"> السعر (الأعلى إلى الأقل)</a>
        <a class="dropdown-item" href="#"> تاريخ الاضافة (من الأحدث إلى الأقدم) </a>
...
<div style="color:#31AFF5;font-size: 20px;" class="nav-item dropdown">
  ...
  <div style="margin-right:0px!important;float: right !important;text-align: center!important;"class="dropdown-menu dropdown-menu-right dropdown-default"
    aria-labelledby="navbarDropdownMenuLink-4">
    <a class="dropdown-item" href="#">أقل من ١٠ جنيهات</a>
    <a class="dropdown-item" href="#">من ١٠ جنيه إلى ٥٠ جنيه</a>
    <a class="dropdown-item" href="#">من ٥٠ جنيه إلى ٧٠ جنيه</a>
    <a class="dropdown-item" href="#">من ٧٠ جنيه إلى ١٠٠ جنيه</a>
    <a class="dropdown-item" href="#">من ١٠٠ جنيه إلى ١٥٠ جنيه</a>
    <a class="dropdown-item" href="#">من ١٥٠ جنيه إلى ٢٠٠ جنيه</a>
    <a class="dropdown-item" href="#">من ٢٠٠ جنيه فأكثر</a>
  </div>
</div>
<!-- End Header -->
...
<!--Start body-->
    ...
    <div class="px-lg-0">
      ...
      <div style="color: #2196f3 !important;"class="container text-white py-5 text-center">
        <h1 class="display-4">كارفور</h1>
        <p class="lead mb-0">اللحوم والأسماك</p>
                      ...
                      <th scope="row" class="border-0">
                        <div class="p-2">
                          ...
                          <div class="ml-3 d-inline-block align-middle">
                            <h5 class="mb-0"> <a href="#" class="text-dark d-inline-block align-middle">لحم بقري طازج</a></h5><span class="text-muted font-weight-normal font-italic d-block">الوزن: ٥٠٠ جرام
                            </span>
                          </div>
                        </div>
                      </th>
                      <td class="border-0 align-middle"><strong>١٠٣جنيه</strong></td>
                    ...
                    <tr>
                      <th scope="row">
                        <div class="p-2">
                          ...
                          <div class="ml-3 d-inline-block align-middle">
                            <h5 class="mb-0"><a href="#" class="text-dark d-inline-block">دجاج طازج</a></h5><span class="text-muted font-weight-normal font-italic">الوزن: ٥٠٠ جرام</span>
                          </div>
                        </div>
                      </th>
                      <td class="align-middle"><strong>٤۹جنيه</strong></td>
