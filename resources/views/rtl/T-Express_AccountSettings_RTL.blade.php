    ...
    <!--Start My Account-->
      ...
      <div class="card">
                <form class="text-center" action="#!">
                    ...
                    <p style="color: #2196f3 !important;" class="h4 mb-4">إعدادات الحساب</p>

                    <div class="form-row mb-4">
                        <div class="col">
                          
                            <input type="text" id="defaultRegisterFormFirstName" class="form-control" placeholder="الاسم الاول">
                        </div>
                        <div class="col">
                          
                            <input type="text" id="defaultRegisterFormLastName" class="form-control" placeholder="الاسم الثاني">
                        </div>
                    </div>
                    <div class="form-row mb-4">
                        <div class="col">
                            
                            <input type="text" id="defaultRegisterFormFirstName" class="form-control" placeholder=" الإيميل">
                        </div>
                        <div class="col">
                            
                            <input type="text" id="defaultRegisterFormLastName" class="form-control" placeholder="رقم الهاتف">
                        </div>
                    </div>

                    <input type="email" id="defaultRegisterFormEmail" class="form-control mb-4" placeholder="العنوان">
                    ...
                    <small id="defaultRegisterFormPhoneHelpBlock" class="form-text text-muted mb-4">
                      قم برفع صورة بطاقة الرقم القومي
                      </small>
                    <button  style="background-color:#2196f3 !important;" class="btn btn-info my-4 btn-block rounded-pill" type="submit">حفظ التعديلات</button>
