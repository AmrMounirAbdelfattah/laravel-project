...
<!--Start body-->
    ...
    <div class="px-lg-0">
      ...
      <div style="color: #2196f3 !important;"class="container text-white py-5 text-center">
        ...
        <p class="lead mb-0">أختر أحد طلباتك !</p>
                  ...
                  <thead>
                    <tr style="background-color:#c6e2ff!important;">
                      <th scope="col" class="border-0">
                        <div style="font-size: 20px!important;color: #2196f3 !important; font-weight: 700!important;" class="p-2 px-3 text-uppercase">رقم الطلب</div>
                      </th>
                      <th scope="col" class="border-0">
                        <div style="font-size: 20px!important;color: #2196f3 !important;" class="py-2 text-uppercase"><i class="fas fa-money-bill-wave"></i></div>
                      </th>
                      <th scope="col" class="border-0">
                        <div style="font-size: 20px!important;color: #2196f3 !important;" class="py-2 text-uppercase"><i class="fas fa-calendar-alt"></i></div>
                      </th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <th scope="row" class="border-0">
                        <div class="ml-3 d-inline-block align-middle">
                            <h5 class="mb-0"> <a href="T-Express_MyOrders-Page-2_RTL" class="text-dark d-inline-block align-middle">123456789</a></h5><span class="text-muted font-weight-normal font-italic d-block">السوق: صقر دايلى ماركت‎</span>
                          </div>
                        </div>
                      </th>
                      <td class="border-0 align-middle"><strong>٢٠٠جنيه</strong></td>
                      <td class="border-0 align-middle">٢٠١٩/١٠/١٩<a class="text-dark">
                    </tr>
                    <tr>
                      <th scope="row">
                          <div class="ml-3 d-inline-block align-middle">
                            <h5 class="mb-0"><a href="T-Express_MyOrders-Page-2_RTL" class="text-dark d-inline-block">789456123</a></h5><span class="text-muted font-weight-normal font-italic">السوق: صقر دايلى ماركت</span>
                          </div>
                      </th>
                      <td class="align-middle"><strong>١٥٠جنيه</strong></td>
                      <td class="align-middle">٢٠١٩/٧/١٠<a href="#" class="text-dark">
                      </td>
                    </tr>
                  </tbody>
                </table>
