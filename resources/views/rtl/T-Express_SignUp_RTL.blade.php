...
<!--Start body-->
  ...
  <!--Start Sign Up-->
    ...
    <form method="POST" action="{{ route('register') }}">
                ...
                <p style="color: #2196f3 !important;" class="h4 mb-4">التسجيل</p>

                
                <input type="text"class="form-control mb-4 @error('name') is-invalid @enderror" name="name" placeholder="الاسم" value="{{ old('name') }}" required autocomplete="name" autofocus>
                ...
                <!-- E-mail -->
                <input id="email" type="email" class="form-control mb-4 @error('email') is-invalid @enderror" placeholder="الإيميل" name="email" value="{{ old('email') }}" required autocomplete="email">
                      ...
                      @enderror
                <!-- Password -->
                <input id="password" type="password" class="form-control mb-4 @error('password') is-invalid @enderror"placeholder="كلمة المرور" name="password" required autocomplete="new-password">
                <small id="defaultRegisterFormPasswordHelpBlock" class="form-text text-muted mb-4">
                ما لا يقل عن 8 أحرف ورقم واحد
                </small>
                  @error('password')
                      <span class="invalid-feedback" role="alert">
                          <strong>{{ $message }}</strong>
                  ...
                  <input id="password-confirm" type="password" class="form-control mb-4"placeholder="تأكيد كلمة المرور" name="password_confirmation" required autocomplete="new-password">
                <!-- Phone number -->
                <input type="text" id="defaultRegisterPhone" class="form-control mb-4" name="Phone"placeholder="رقم الهاتف" aria-describedby="defaultRegisterFormPhoneHelpBlock">
                ...
                هل لديك حساب؟
                    ...
                    <a style="color: red;" href="T-Express_SignIn_RTL">تسجيل الدخول</a>  
                </div>
                <!-- Sign up button -->
                <button  style="background-color:#2196f3 !important;" class="btn btn-info my-4 btn-block rounded-pill" type="submit">تسجيل</button>
                ...
                <!-- Terms of service -->
                <p>بالضغط  علي
                    <em>تسجيل</em> أنت توافق على
                    <a style="color: red;" href="" target="_blank">شروط الخدمة</a>
