    ...
    <!--Start Change Password-->
        ...
        <div class="card">
            ...
            <form class="text-center border-light" action="#!">
              ...
              <p style="color: #2196f3 !important;"class="h4 mb-4">هل نسيت كلمة المرور؟</p>

              <p style="color: #2196f3 !important;"class=" mb-4">لا داعى للقلق! أدخل بريدك الإلكتروني وسنرسل لك رسالة .</p>

              <input type="email" id="defaultLoginFormEmail" class="form-control mb-4" placeholder="الإيميل">

              <button style="background-color:#2196f3 !important;" class="btn btn-info btn-block my-4 rounded-pill" type="submit">ارسل طلب</button>
              <p>العودة إلى
                <a style="color: #2196f3;" href="T-Express_SignIn_RTL">تسجيل الدخول</a>
            </p>
            </form>
        </div>
        </div>
