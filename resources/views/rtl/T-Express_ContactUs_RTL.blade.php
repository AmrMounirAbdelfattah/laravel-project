    ...
    <!--Start Contact Us-->
      ...
      <div class="card">
              ...
              <form class="text-center border-light" action="#!">
                ...
                <p style="color: #2196f3 !important;" class="h4 mb-4">تواصل معنا</p>

                <!-- Name -->
                <input type="text" id="defaultContactFormName" class="form-control mb-4" placeholder="الاسم">

                <!-- Email -->
                <input type="email" id="defaultContactFormEmail" class="form-control mb-4" placeholder="الإيميل">
                ...
                <small id="defaultRegisterFormPhoneHelpBlock" class="form-text text-muted mb-4">
                  قم برفع صور أو ملفات
                  </small>
                <!-- Subject -->
                <select class="browser-default custom-select mb-4">
                    <option value="" disabled>الخيارات</option>
                    <option value="3">انضم إلينا</option>
                    <option value="1" selected>الملاحظات</option>
                ...
                <div style="background-color: #c6e2ff;" class="custom-checkbox mb-4 rounded-pill py-3 text-uppercase font-weight-bold">
                    ...
                    <label class="custom-control-label" for="defaultContactFormCopy">ارسل لي نسخة من الرسالة</label>
                </div>

                <!-- Send button -->
                <button style="background-color:#2196f3 !important;" class="btn btn-info btn-block rounded-pill" type="submit">إرسال</button>
